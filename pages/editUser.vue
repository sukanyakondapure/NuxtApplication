    ...
    <div class="content">
      <div class="module">
        ...
        <div class="module-body">
          <form class="form-horizontal row-fluid" @submit.prevent="postPost">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="span8" name="address" v-model="address" rows="5"></textarea>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    postPost() {
      axios
        .put(`http://nuxtapi.com/api/user/{id}`, {
          name: this.name,
          email: this.email,
          gender: this.gender,
          mobile: this.mobile,
